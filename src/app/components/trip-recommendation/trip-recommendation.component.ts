...
export class TripRecommendationComponent {
  ...
  private tripRecommendationService: TripRecommendationService = inject(TripRecommendationService);
  private statisticsService: StatisticsService = inject(StatisticsService);
  @ViewChild(ModalComponent) modal!: ModalComponent;

  constructor() {
    this.getCountryFlagCodes();
    this.tripRecommendation = this.tripRecommendationService.tripRecommendationSig;
  }
