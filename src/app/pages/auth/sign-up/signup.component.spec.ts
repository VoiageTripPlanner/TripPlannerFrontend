...
describe("SigUpComponent", () => {
  ...
  it("should handle the form submit", () => {
    const loginResponseStub: ILoginResponse = {
      accessToken: "",
      expiresIn: 100000,
    };
    const signupSpy = jest
      .spyOn(component["authService"], "signup")
      .mockReturnValue(of(loginResponseStub));
  ...
  it("should filter countries with given value", () => {
    ...
    jest
      .spyOn(component["countryService"], "countriesSig")
      .mockReturnValue(countryListStub);
  ...
  it("should filter countries with given value", () => {
    ...
    jest
      .spyOn(component["currencyService"], "currenciesSig")
      .mockReturnValue(currencyListStub);
