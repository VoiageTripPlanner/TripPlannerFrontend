...
export class UserProfileComponent {
  ...
  private countryInterestService: UserCountryInterestService = inject(UserCountryInterestService);
  ...
  constructor() { 
    ...
    this.countryInterestData = this.countryInterestService.userCountryInterestSig;
    effect(() => {
  ...
  public saveCountryInterest(countryInterest: ICountryInterest): void {
    const countryInterestToSave: ICountryInterest = {userId: this.userId, savedCountries: [], deletedCountries: []};
    ...
    this.countryInterestService.updateUserCountryInterest(countryInterestToSave);
  }
}
