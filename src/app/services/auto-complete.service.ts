...
import { IAutoComplete, IAutoCompleteLocation } from '../interfaces/auto-complete.interface';
...
export class AutoCompleteService extends BaseService<IAutoComplete>   {
  ...
  private autoCompleteSignal = signal<IAutoComplete>(this.onGetDefaultAutoComplete());
